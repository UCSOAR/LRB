...
void LoggingTask::InitTask() {
  ...
  SOAR_ASSERT(rtTaskHandle == nullptr, "Cannot initialize Logging task twice");

  // Start the task
  BaseType_t rtValue = xTaskCreate(
      (TaskFunction_t)LoggingTask::RunTask, (const char *)"LoggingTask",
      (uint16_t)TASK_LOGGING_QUEUE_DEPTH_WORDS, (void *)this,
      (UBaseType_t)TASK_LOGGING_PRIORITY, (TaskHandle_t *)&rtTaskHandle);
...
// 		break;
	...
	case DataBrokerMessageTypes:: ANEMOMETER_DATA:
	{
