...
#include "main.h"
#include "..\..\Drivers\Components\Inc\MAX31856MUD+Driver.hpp"
#include "..\..\Drivers\Components\Inc\Buzzer.hpp"
#include <stdio.h>
...
/* USER CODE BEGIN 0 */
MAX31856Driver tc1;
Buzzer buzzer(&htim1, TIM_CHANNEL_1);
// Add other driver objects here as needed
...
// Drivers initialization function
void Drivers_Init()
{
    tc1.init(&hspi1, TC1_cs_GPIO_Port, TC1_cs_Pin); // Example
    buzzer.init();
    // Add other driver initializations here
}
...
int main(void)
{
  ...
  while (1)
  {
    tc1.task();      // Thermocouple periodic logic
    buzzer.task();   // Buzzer periodic logic
    // Add other driver task calls here
